...
import ColorRateSection from "./components/ColorRate/ColorRateSection"
...
export default class App extends Component {
  ...
  _onNext = () => {
    ...
    if(!colors.includes(1) || !colors.includes(2) || !colors.includes(3) || !colors.includes(4)) {
        ...
        >
          <View style={{backgroundColor:"rgba(0,0,0,0.9)", height:"100%",display:"flex", justifyContent:"space-between", alignItems:"center"}}>
            <View style={{height:"40%", justifyContent:"flex-end", width: "80%"}}>
              <Text style={{marginTop:10,color:"white", fontSize:18, textAlign:"center"}}>Make sure to only select one number that is different from every other section</Text>
